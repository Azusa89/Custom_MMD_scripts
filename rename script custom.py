...
arm_dict = {
	"右肩": ["cf_J_Shoulder02_s_R", "mixamorig:RightShoulder", "ValveBiped.Bip01_R_Clavicle", "bip_collar_R", "SK_R_Shoulder", "cf_d_shoulder_R", "cf_j_shoulder_R", "cf_s_shoulder02_R", "a_n_shoulder_R", "k_f_shoulderR_00", "k_f_shoulderR_01", "k_f_shoulderR_02", "k_f_shoulderR_03", "cf_hit_shoulder_R"],
	"右腕": ["cf_J_ArmUp01_s_R", "mixamorig:RightArm", "ValveBiped.Bip01_R_UpperArm", "bip_upperArm_R", "RF_R_ArmNoTwist", "RF_R_Arm_00", "RF_R_Arm_01", "SK_R_Arm", "cf_d_arm01_R", "cf_s_arm01_R", "cf_d_arm02_R", "cf_s_arm02_R", "a_n_arm_R", "k_f_armupR_00", "k_f_armupR_01", "k_f_armupR_02", "k_f_armupR_03", "KK_Colliders_cf_s_arm02_R", "cf_d_arm03_R", "cf_s_arm03_R", "cf_hit_arm_R"],
	"右ひじ": ["cf_J_ArmLow01_s_R", "mixamorig:RightForeArm", "ValveBiped.Bip01_R_Forearm", "bip_lowerArm_R", "SK_R_ForeArm", "RF_R_ForeArm_00", "RF_R_ForeArm_01", "cf_d_forearm02_R", "cf_s_forearm02_R", "cf_hit_wrist_R", "KK_Colliders_cf_s_forearm02_R", "cf_d_wrist_R", "cf_s_wrist_R", "cf_s_wrist_R", "a_n_wrist_R", "cf_d_hand_R", "cf_s_forearm01_R"],
	"右手首": ["cf_J_Hand_s_R", "mixamorig:RightHand", "ValveBiped.Bip01_R_Hand", "bip_hand_R", "SK_R_Hand", "cf_s_hand_R", "a_n_hand_R"],
	
	"左肩": ["cf_J_Shoulder02_s_L", "mixamorig:LeftShoulder", "ValveBiped.Bip01_L_Clavicle", "bip_collar_L", "SK_L_Shoulder", "cf_d_shoulder_L", "cf_j_shoulder_L", "cf_s_shoulder02_L", "a_n_shoulder_L", "k_f_shoulderL_00", "k_f_shoulderL_01", "k_f_shoulderL_02", "k_f_shoulderL_03", "cf_hit_shoulder_L"],
	"左腕": ["cf_J_ArmUp01_s_L", "mixamorig:LeftArm", "ValveBiped.Bip01_L_UpperArm", "bip_upperArm_L", "RF_L_ArmNoTwist", "RF_L_Arm_00", "RF_L_Arm_01", "SK_L_Arm", "cf_d_arm01_L", "cf_s_arm01_L", "cf_d_arm02_L", "cf_s_arm02_L", "a_n_arm_L", "k_f_armupL_00", "k_f_armupL_01", "k_f_armupL_02", "k_f_armupL_03", "KK_Colliders_cf_s_arm02_L", "cf_d_arm03_L", "cf_s_arm03_L", "cf_hit_arm_L"],
	"左ひじ": ["cf_J_ArmLow01_s_L", "mixamorig:LeftForeArm", "ValveBiped.Bip01_L_Forearm", "bip_lowerArm_L", "SK_L_ForeArm", "RF_L_ForeArm_00", "RF_L_ForeArm_01", "cf_d_forearm02_L", "cf_s_forearm02_L", "cf_hit_wrist_L", "KK_Colliders_cf_s_forearm02_L", "cf_d_wrist_L", "cf_s_wrist_L", "cf_s_wrist_L", "a_n_wrist_L", "cf_d_hand_L", "cf_s_forearm01_L"],
	"左手首": ["cf_J_Hand_s_L", "mixamorig:LeftHand", "ValveBiped.Bip01_L_Hand", "bip_hand_L", "SK_L_Hand", "cf_s_hand_L", "a_n_hand_L"]
}

leg_dict = {
	"右足": ["cf_J_LegUp01_s_R", "mixamorig:RightUpLeg", "ValveBiped.Bip01_R_Thigh", "bip_hip_R", "SK_R_UpLeg", "RF_R_UpLeg_00", "RF_R_UpLeg_01", "cf_d_thigh01_R", "cf_s_thigh01_R", "cf_hit_thigh01_R", "k_f_legupR_00", "k_f_legupR_01", "k_f_legupR_02", "k_f_legupR_03", "KK_Colliders_cf_s_thigh01_R", "KK_Colliders_cf_s_thigh01_R__2", "cf_d_thigh02_R", "cf_s_thigh02_R", "a_n_leg_R", "cf_hit_thigh02_R", "KK_Colliders_cf_s_thigh02_R", "cf_d_thigh03_R", "cf_s_thigh03_R"],
	"右ひざ": ["cf_J_LegLow01_s_R", "mixamorig:RightLeg", "ValveBiped.Bip01_R_Calf", "bip_knee_R", "SK_R_Leg", "RF_R_Leg_00", "RF_R_Leg_01", "cf_d_kneeF_R", "k_f_legkneeR_00", "k_f_legkneeR_01", "k_f_legkneeR_02", "k_f_legkneeR_03", "cf_d_leg02_R", "cf_s_leg02_R", "cf_d_leg03_R", "cf_s_leg03_R", "a_n_ankle_R", "k_f_ancleR_00", "k_f_ancleR_01", "k_f_ancleR_02", "k_f_ancleR_03", "cf_j_leg03_R", "cf_s_leg01_R"],
...
body_dict = {
	...
	"下半身": ["cf_J_Kosi01_s", "mixamorig:Hips", "ValveBiped.Bip01_Pelvis", "bip_pelvis", "ValveBiped.Bip01_Spine", "bip_spine_0", "SK_Hips", "cf_s_waist02"],
	"上半身": ["mixamorig:Spine", "ValveBiped.Bip01_Spine1", "bip_spine_1", "SK_Spine01", "cf_s_waist01", "a_n_waist", "a_n_waist_b", "a_n_waist_f", "a_n_waist_L", "a_n_waist_R", "cf_s_spine01", "k_f_spine01_00", "k_f_spine01_01", "k_f_spine01_02", "k_f_spine01_03", "cf_J_Spine01_s"],
